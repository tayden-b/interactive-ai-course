...
const features = [
  {
    number: "01",
    title: "Models, not magic",
    description: "Build a working mental model of tokens, context, and prediction before you touch a framework.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "Prompt as interface",
    description: "Learn why prompts fail, how to make them testable, and where structured output belongs.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Tools and loops",
    description: "Give an agent tools, observe its decisions, and build an evaluation loop that improves the system.",
    visual: "collab",
  },
  {
    number: "04",
    title: "The agent boundary",
    description: "Know what the model can decide, what your code must decide, and how to keep both inspectable.",
    visual: "security",
  },
];
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16 lg:mb-24">
          ...
          >
            ...
            <br />
            <span className="text-muted-foreground">the modern AI stack.</span>
          </h2>
        </div>
