...
workflow: fixed path          workflow: no path matches
  ...
  },
  {
    ...
    line: "A lead agent plans and delegates; worker agents each do one part in their own small window; the lead synthesizes. The point is context isolation.",
  ...
  },
  {
    ...
    line: "Put a person at the points where being wrong is expensive: approving risky actions, resolving ambiguity, verifying the final result. Design the pause so it's cheap to answer.",
