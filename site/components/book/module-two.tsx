...
attempt 2: success · 212 input tokens · $0.003`}</Code>
    ...
    paragraphs: ["This is the first thing you build that a person could rely on. Not because the model is reliable (it isn't) but because your code is.", "Keep the scope small. Three fields. Real notes from a real meeting. When it works, feed it the messiest notes you have and watch the retry earn its keep.", "The guided version of this project is coming to the lab. Until then, the build list above is the plan: work through it with your own coding agent, one item at a time."], key: "Reliability lives in your code around the model, not in the model.", deeper: "Thorsten Ball, How to build an agent", url: "https://ampcode.com/how-to-build-an-agent" },
]
